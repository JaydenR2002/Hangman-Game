...
$(function() {
    ...
    $('#btnSubmit').click(function() {
        ...
        if (input === '') {
            alert('Woord dat speler 2 moet raden mag niet leeg zijn');
        } else if (input.indexOf(' ') != -1) {
            $('#guessWord').val('');
            alert('Je kan helaas maar 1 woord gebruiken');
        } else {
...
function gameLost() {
    alert('Verloren! Volgende keer beter!');
    playing = false;
alert("Vraag maar aan speler 1 wat het woord was :)");
}
